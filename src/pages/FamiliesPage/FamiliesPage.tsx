...
import { useFamiliesPage } from "./hooks";
...
export const FamiliesPage = () => {
  const {
    state: { listFamilies, columns, alertDialogRemove },
      ...
      <>
        ...
        >
          ...
          <Flex justifyContent="flex-end">
            <Link to={`${routerPaths.families}/create`}>
              <Button
                colorScheme="teal"
                size="sm"
        ...
        <Box w="100%">
          <Table columns={columns} dataSource={listFamilies} />
        </Box>
        <AlertDialog
