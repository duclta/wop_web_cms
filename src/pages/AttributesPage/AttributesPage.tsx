...
import { useAttributesPage } from "./hooks";
...
export const AttributesPage = () => {
  const {
    state: { listAttributes, columns, alertDialogRemove },
      ...
      <>
        ...
        >
          ...
          <Flex justifyContent="flex-end">
            <Link to={`${routerPaths.attributes}/create`}>
              <Button
                colorScheme="teal"
                size="sm"
        ...
        <Box w="100%">
          <Table columns={columns} dataSource={listAttributes} />
        </Box>
        <AlertDialog
  ...
  return (
    <>
      <Helmet>
        <title>Attributes - WOP CMS</title>
      </Helmet>
      <Wrapper>
