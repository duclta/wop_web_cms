...
export const TabsPage = () => {
  const {
    state: { listTabs, columns, alertDialogRemove },
      ...
      <>
        ...
        >
          ...
          <Flex justifyContent="flex-end">
            <Link to={`${routerPaths.tabs}/create`}>
              <Button
                colorScheme="teal"
                size="sm"
        ...
        <Box w="100%">
          <Table columns={columns} dataSource={listTabs} />
        </Box>
        <AlertDialog
